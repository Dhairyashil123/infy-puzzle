#  Infosys Dev Puzzle for Internal Review
...
Once you have completed all the tasks, [submit](#submission) your solution to your manager.

## Getting Started

Follow the steps below to get started. 
1. Please fork this project to your infygit repo. 
2. Change project visibility of forked project to private, so others can't see your solution. Setting >General > Visibility = Private > Save changes
3. Clone project from your infy repo
4. Install dependencies with `npm install`.
5. You should be able to start the app with npm start.
6. The app runs at http://localhost:4200.
7. Provide Read access to reviewer, since its a private project. Setting > Members > Guest and reviewer's infosys user name
8. Don't forgot add reviewer name on all PRs  

The above steps will not be applicable during actual submission. so don't fork the project for actual puzzle, will share you the link once your readiness is YES  
...
Once you are done, send the link to your repo to your manager for evaluation.
